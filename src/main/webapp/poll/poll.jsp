...
<div id="nav-scroll" data-bs-spy="scroll" data-bs-target=".navbar"
    data-bs-offset="50">
 
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-bottom">
        <div class="container-fluid">
            <ul class="navbar-nav">
                <li class="nav-item"><a class="nav-link" href="#section1">설문 목록</a></li>
                <li class="nav-item"><a class="nav-link" href="#section2">설문 정보</a></li>
                <li class="nav-item"><a class="nav-link" href="#section3">설문 작성</a></li>
            </ul>
        </div>
    </nav>
