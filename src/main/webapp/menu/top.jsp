      ...
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li>
              <a class="dropdown-item" href="<%=root%>/bbs/list.jsp"
                >게시판 목록</a
              >
            </li>

            <li>
              <a class="dropdown-item" href="<%=root%>/bbs/createForm.jsp"
                >게시판 생성</a
              >
            </li>
          </ul>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li>
              <a class="dropdown-item" href="<%=root%>/notice/list.jsp"
                >공지사항 목록</a
              >
            </li>

            <li>
              <a class="dropdown-item" href="<%=root%>/notice/createForm.jsp"
                >공지사항 생성</a
              >
            </li>
          </ul>
        ...
        <li class="nav-item">
          <a class="nav-link" href="<%=root%>/poll/poll.jsp">투표</a>
        </li>
