...
<% Map map = new HashMap(); map.put("bbsno", dto.getBbsno());
map.put("passwd",dto.getPasswd()); boolean pflag = dao.passCheck(map); boolean
flag = false; if (pflag) flag = dao.update(dto); %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>게시판 수정</title>
  ...
  <body>
    ...
    <div class="container mt-3">
      <div class="container p-5 my-5 border">
        ...
        out.print("Success update writing"); } else { out.print("Fail update");
        } %>
      </div>
      <% if (!pflag) { %>
